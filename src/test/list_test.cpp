...
TEST(ListTest, Permutations) {
  ...
  EXPECT_EQ(permutations(List<int, bool>{}),
            (List<List<int, bool>, List<bool, int>>{}));
  EXPECT_EQ(permutations(List<int, bool, long>{}),
            (List<List<int, bool, long>, List<int, long, bool>,
                  List<bool, int, long>, List<bool, long, int>,
                  List<long, int, bool>, List<long, bool, int>>{}));
}
...
TEST(ListTest, Star) {
  ...
  // Multiple
  EXPECT_EQ(int{} * (List<List<float, double>>{}),
            (List<List<int, float, double>>{}));
  EXPECT_EQ(int{} * (List<List<bool>, List<long>>{}),
            (List<List<int, bool>, List<int, long>>{}));
  EXPECT_EQ((List<List<float, double>>{}) * int{},
            (List<List<float, double, int>>{}));
  EXPECT_EQ((List<List<bool>, List<long>>{}) * int{},
            (List<List<bool, int>, List<long, int>>{}));
  EXPECT_EQ((List<List<bool>, List<long>>{}) * (List<List<int>, List<char>>{}),
            (List<List<bool, int>, List<bool, char>, List<long, int>,
                  List<long, char>>{}));
}
